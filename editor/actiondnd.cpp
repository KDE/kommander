...
void QDesignerToolBar::contextMenuEvent( QContextMenuEvent *e )
{
    ...
    if ( res != -1 ) {
	RemoveToolBarCommand *cmd = new RemoveToolBarCommand( i18n("Delete Toolbar '%1'", name() ),
							      formWindow, 0, this );
...
void QDesignerMenuBar::contextMenuEvent( QContextMenuEvent *e )
{
	...
	if ( ok ) {
		...
		i18n("Rename Menu '%1' to '%2'", old, txt ),
...
void QDesignerMenuBar::dropEvent( QDropEvent *e )
{
    ...
    MoveMenuCommand *cmd = new MoveMenuCommand( i18n("Move Menu '%1'", txt ), formWindow,
