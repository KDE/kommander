      ...
      } else
      {
        ...
        else                    // see if this is an identifier
        {
                     ...
                     || identifier == "writeSetting")
          {
            ...
            if (baseText[pos++] != '(')
            {
              printError(QString(m_thisObject->name()),
                         i18n("Expected \'(\' after \'%1\'\n").arg(identifier));
              return QString::null;
            }
            ...
            QString arg = evalAssociatedText(baseText.mid(startpos,
                                                          pos - startpos -
                                                          1));
            ...
            else if (identifier == "exec")
            {
              ...
              {
                printError(QString(m_thisObject->name()),
                           i18n("Error" " parsing arguments to @exec"));
                return QString::null;
              }
          ...
          } else if (identifier == "execBegin")
          {
            ...
            {
              printError(QString(m_thisObject->name()),
                         i18n("Unterminated @execBegin ... @execEnd block"));
          ...
          } else
          {
            ...
            {
              printError(QString(m_thisObject->name()),
                         i18n("Unterminated text block \'%1\'").
                         arg(identifier));
              return QString::null;
            }
